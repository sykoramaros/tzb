...
const Mobile_Steam = () => {
  ...
  const base_info = [
    ...
    {
      subtitle: "Výkon",
      article: "1,6 – 12 tun páry / hod. (1 až 8 MW)",
    },
  ]
  ...
  const heating_section = [
    {
      subtitle: "Parametry",
      article: "max. pracovní tlak páry 8 bar",
    },
    {
      subtitle: "Kotel",
      article:
    ...
    {
      subtitle: "Kondenzát",
      article: "standartní návratnost kondenzátu nad 50%, teplota nad 80°C",
    },
    {
  ...
  const extra_heating_section = [
    {
      subtitle: "Vyšší tlak",
      article: "pracovní tlak páry nad 8 bar",
    },
    {
      subtitle: "Rezervní čerpadlo",
      article:
        "rezervní čerpadlo s automatickým záskokem ve spojení s řídícím systémem",
    },
    {
      subtitle: "Měřidla",
      article: "měřič vyrobené páry",
    },
    {
      subtitle: "Regulátor",
    ...
    {
      subtitle: "Hořák gas – oil",
      article: "kombinované hořáky pro 2 paliva – zemní plyn a topný olej",
    },
  ]
